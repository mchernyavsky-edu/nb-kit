...
inline fun <reified T : PsiElement> Collection<PsiElement>.childrenOfType(stopAt: PsiElement? = null): Collection<T> =
        flatMap { it.children.takeWhile { it !== stopAt }.filterIsInstance<T>() }
